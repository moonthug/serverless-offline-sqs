...
aws sqs --endpoint-url http://localhost:9324 send-message \
    --queue-url http://localhost:9324/queue/MyFourthQueue \
    --message-body "MyFourthMessage" \
    --message-attributes '{ "id": { "DataType":"String","StringValue":"123" }, "name" :{ "DataType":"String","StringValue":"Fred Durst" } }'
```